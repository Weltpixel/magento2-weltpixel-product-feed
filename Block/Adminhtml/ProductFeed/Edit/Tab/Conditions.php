...
class Conditions extends Generic implements TabInterface
{
    ...
    public function __construct(
        ...
        $this->setNameInLayout('weltpixel_productfeed_edit_tab_conditions');
     ...
     */
    protected function addTabToForm($model, $fieldsetId = 'conditions_fieldset', $formName = 'weltpixelproductfeed_productfeed_form')
    {
        /** @var \Magento\Framework\Data\Form $form */
        ...
        $renderer = $this->_rendererFieldset->setNameInLayout('weltpixel_productfeed_edit_tab_conditions_renderer_fieldset')->setTemplate('Magento_CatalogRule::promo/fieldset.phtml')
