<?php
namespace WeltPixel\ProductFeed\Model;

/**
 * Class Sitemap
 * @package WeltPixel\Sitemap\Model
 */
class ProductFeed extends \Magento\Rule\Model\AbstractModel
{
    const CACHE_TAG = 'weltixel_productfeed';

    /**
     * @var string
     */
    protected $_cacheTag = 'weltixel_productfeed';
     ...
     * @var string
     */
    protected $_eventPrefix = 'weltixel_productfeed';
    ...
    {
        $this->_init('WeltPixel\ProductFeed\Model\ResourceModel\ProductFeed');
    }
