...
class Index extends \WeltPixel\ProductFeed\Controller\Adminhtml\ProductFeed
{
    /**
    ...
    public function execute()
    {
        ...
        $this->initPage($resultPage)->getConfig()->getTitle()->prepend(__('Add Product Feed'));
        ...
        $dataPersistor->clear('weltpixel_productfeed');
